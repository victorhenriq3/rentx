...
describe("Create rental", function () {
    ...
    it("should not to be able to create a new rental if there is another open to the same user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("should not to be able to create a new rental if there is another open to the same car", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rentalsRepositoryInMemory.create({
                        car_id: "test",
    ...
    it("should not to be able to create a new rental if invalid return time", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
