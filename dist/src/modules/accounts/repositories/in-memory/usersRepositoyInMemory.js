...
var UserRepositoryInMemory = /** @class */ (function () {
    function UserRepositoryInMemory() {
        this.users = [];
    }
    UserRepositoryInMemory.prototype.create = function (_a) {
    ...
    UserRepositoryInMemory.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UserRepositoryInMemory.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
