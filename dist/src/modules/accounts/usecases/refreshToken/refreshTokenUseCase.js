...
var RefreshTokenUseCase = /** @class */ (function () {
    function RefreshTokenUseCase(usersTokenRepository, dateProvider) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        user_id = sub;
                        return [4 /*yield*/, this.usersTokenRepository.findByUserIdAndRefreshToken(user_id, token)];
                    case 1:
                        userToken = _b.sent();
                        if (!userToken) {
                            throw new AppError_1.AppError("Refresh token does not exists!");
                        }
                        return [4 /*yield*/, this.usersTokenRepository.deleteById(userToken.id)];
                    case 2:
                        _b.sent();
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, { refresh_token: refresh_token, token: newToken }];
                }
            });
        });
    };
