...
var ResetPasswordUserUseCase = /** @class */ (function () {
    function ResetPasswordUserUseCase(usersTokenRepository, dateProvider, usersRepository) {
    ...
    ResetPasswordUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.usersTokenRepository.findByRefreshToken(token)];
                    case 1:
                        userToken = _c.sent();
                        if (!userToken) {
