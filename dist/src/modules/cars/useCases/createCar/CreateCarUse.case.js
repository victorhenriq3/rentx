...
var CreateCarUseCase = /** @class */ (function () {
    function CreateCarUseCase(carsRespository) {
    ...
    CreateCarUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.carsRespository.finfByLicensePlate(license_plate)];
                    case 1:
                        carAlreadyExists = _b.sent();
                        if (carAlreadyExists) {
                            throw new AppError_1.AppError("Car already exists");
                        }
                        return [4 /*yield*/, this.carsRespository.create({
                                name: name,
