...
describe("Create category controller", function () {
    ...
    it("should not to be able to create a new category with name exists", function () { return __awaiter(void 0, void 0, void 0, function () {
