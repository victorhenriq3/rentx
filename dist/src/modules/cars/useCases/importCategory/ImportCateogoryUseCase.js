...
var ImportCateogoryUseCase = /** @class */ (function () {
    function ImportCateogoryUseCase(categoriesRepository) {
        this.categoriesRepository = categoriesRepository;
    }
    ImportCateogoryUseCase.prototype.loadCategories = function (file) {
        var _this = this;
    ...
    ImportCateogoryUseCase.prototype.execute = function (file) {
    ...
    ImportCateogoryUseCase = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("CategoriesRepository")),
        __metadata("design:paramtypes", [Object])
    ], ImportCateogoryUseCase);
    return ImportCateogoryUseCase;
}());
